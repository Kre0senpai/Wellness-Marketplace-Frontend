...
const Bookings = () => <div className="p-8"><h1 className="text-3xl">Bookings Page - Coming Soon</h1></div>;
const Orders = () => <div className="p-8"><h1 className="text-3xl">Orders Page - Coming Soon</h1></div>;
